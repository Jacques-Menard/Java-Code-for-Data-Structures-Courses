 ...
 */
package symmetricencryptionpart2.java;
...
public class SymmetricEncryptionPart2{
     ...
     * My vigener key is courage
     * My permutation key is (2,6,5,0,1,3,4)
    ...
    public static String Vigoner(){
        ...
        try {
            ...
            Logger.getLogger(SymmetricEncryptionPart2.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    ...
    /**
     * Permutation creates a string cyphertext using a permutation cypher.
     * Only accepts keys no longer then 7 integers long and requires a all special characters to be removed and all caps to be replaced with a lower case.
     * @return a cyphertext string of the given plaintext.
     */
    public static String Permutation(){
        ...
        String tempstring = "";
        String nospace = "";
        List<Integer> key = Arrays.asList(2,6,5,0,1,3,4);
        ...
        //reinitializes acouple variables for the while loop
        count=0;
        int i = 0;
        
        //while loop splits key into 7 character boxes and assigns reorders them according to the key.
